...
import type { Clock, Eye, CheckCircle, X } from "lucide-react"

// ── Status ──────────────────────────────────────────────────────────────────

export const STATUS: Record<string, { label: string; color: string; icon: string }> = {
...
export const URGENCY: Record<string, { dot: string; label: string; textColor: string }> = {
